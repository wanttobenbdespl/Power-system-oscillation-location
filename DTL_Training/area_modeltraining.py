...
# 设置区域 1 的图片路径
area_output_dir = '../MoreSamples/area_output/1'
...
# 加载系统级别的预训练模型
base_model = load_model(r'E:\temp\oscillation_detect\DTL-Location-main\DTL-Location-main\DTL FO_Location\DTL_Training\system_level_model.h5')
...
# 保存模型
model.save('area_1_model.h5')

# 打印训练结果
print("Area 1 model training complete.")
